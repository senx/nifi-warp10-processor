...
public class WarpScriptProcessor extends AbstractProcessor {
  ...
  private final PropertyDescriptor WARPSCRIPT = new PropertyDescriptor
  ...
  private final PropertyDescriptor SEMANTICS = new PropertyDescriptor
  ...
  private final PropertyDescriptor MAXFLOWFILES = new PropertyDescriptor
  ...
  private final Relationship FAILURE = new Relationship.Builder()
      .name("FAILURE")
  ...
  public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
    try {
      ...
      if (null == error) {
        ...
        for (Object result: results) {
          ...
          if (map.containsKey(CONTENT_KEY)) {
            ...
            if (map.get(CONTENT_KEY) instanceof byte[]) {
              ...
              content = map.get(CONTENT_KEY).toString().getBytes(StandardCharsets.UTF_8);
            }
        ...
        OutputStream out = session.write(flowFile);
        out.write(error.getMessage().getBytes(StandardCharsets.UTF_8));
        out.close();
